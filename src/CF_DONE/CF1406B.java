...
public class CF1406B {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(t --> 0) {
            ...
            Collections.sort(l);
            String a1 = l.get(0) + "", a2 = l.get(1) + "", a3 = l.get(2) + "", a4 = l.get(3) + "", a5 = l.get(l.size() - 1) + "";

            // maybe if I considered using vars for indices before I started typing
            BigInteger a = (new BigInteger(l.get(0) + "")).multiply(new BigInteger(l.get(1) + "")).multiply(new BigInteger(l.get(2) + "")).multiply(new BigInteger(l.get(3) + "")).multiply(new BigInteger(l.get(l.size() - 1) + ""));
            BigInteger b = (new BigInteger(l.get(l.size() - 1) + "")).multiply(new BigInteger(l.get(l.size() - 2) + "")).multiply(new BigInteger(l.get(l.size() - 3) + "")).multiply(new BigInteger(l.get(l.size() - 4) + "")).multiply(new BigInteger(l.get(l.size() - 5) + ""));
            BigInteger c = (new BigInteger(l.get(0) + "")).multiply(new BigInteger(l.get(1) + "")).multiply(new BigInteger(l.get(l.size() - 1) + "")).multiply(new BigInteger(l.get(l.size() - 2) + "")).multiply(new BigInteger(l.get(l.size() - 3) + ""));
//            long a = l.get(0) * l.get (1) * l.get(2) * l.get(3) * l.get(l.size() - 1),
//                b = (long) l.get(0) * l.get(1) * l.get(l.size() - 1) * l.get(l.size() - 2) * l.get(l.size() - 3),
//                c = (long) l.get(l.size() - 1) * l.get(l.size() - 2) * l.get(l.size() - 3) * l.get(l.size() - 4) * l.get(l.size() - 5);
//            prln(maxof(a, b, c));
            a = a.max(b);
            a = a.max(c);
            prln(a);
