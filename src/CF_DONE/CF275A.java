...
public class CF275A {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[][] a = new int[3][3];
        for(int i = 0; i < 3; ++i) {
            String[] c = rline().split(" ");
            for(int cc = 0; cc < 3; ++cc) {
                a[i][cc] = Integer.parseInt(c[cc]);
            }
        }
        int[][] b = new int[3][3];
        b[0][0] = (a[0][0] + a[0][1] + a[1][0] + 1) % 2;
        b[0][1] = (a[0][0] + a[0][1] + a[0][2] + a[1][1] + 1) % 2;
        b[0][2] = (a[0][1] + a[0][2] + a[1][2] + 1) % 2;
        b[1][0] = (a[0][0] + a[1][0] + a[2][0] + a[1][1] + 1) % 2;
        b[1][1] = (a[0][1] + a[1][0] + a[2][1] + a[1][2] + a[1][1]+ 1) % 2;
        b[1][2] = (a[0][2] + a[1][2] + a[1][1] + a[2][2] + 1) % 2;
        b[2][0] = (a[1][0] + a[2][0] + a[2][1] + 1) % 2;
        b[2][1] = (a[1][1] + a[2][0] + a[2][1] + a[2][2] + 1) % 2;
        b[2][2] = (a[1][2] + a[2][1] + a[2][2] + 1) % 2;
