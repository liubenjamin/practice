...
public class CF1450A {
    public static void main(String[] args) throws IOException {
        ...
        while (t --> 0) {
            ...
            for (int i = 0; i < b; ++i) pr("b");
            for (int i = 0; i < u; ++i) pr("u");
            for (int i = 0; i < g; ++i) pr("g");
            for (int i = 0; i < y; ++i) pr("y");
            for (int i = 0; i < r; ++i) pr("r");
            for (int i = 0; i < tt; ++i) pr("t");
            for (char c : a) {
                if ( c != 't' && c != 'r' && c != 'y' && c != 'g' && c != 'u' && c != 'b')
                    pr(c);
            }
            prln();
        }
